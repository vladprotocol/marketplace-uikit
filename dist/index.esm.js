...
var WalletCard = function (_a) {
    ...
    return (React.createElement("button", { type: "button", className: "btn btn-with-icon text-uppercase", onClick: function () {
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement("div", { className: "ctm-modal modal fade show wallet-modal", id: "connectNft", style: { display: 'block' } },
        React.createElement("div", { className: "modal-dialog ctmmodal-dialog" },
            React.createElement("div", { className: "modal-content" },
                React.createElement("div", { className: "modal-header" },
                    ...
                    React.createElement("button", { type: "button", className: "btn-close ctm-btnclose", "data-bs-dismiss": "modal", "aria-label": "Close", onClick: onDismiss }, "CANCEL")),
                React.createElement("div", { className: "modal-body" },
                    React.createElement("div", { className: "wallet-body" }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })),
                    React.createElement("ul", { className: "wallet-help" },
                        React.createElement("li", null,
                            React.createElement("a", { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain" },
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement("button", __assign({ type: "button", className: "text-uppercase", onClick: function () {
        ...
        isTooltipDisplayed && React.createElement("span", { className: "btn-tooltip" }, "Copied")));
};

var AccountModal = function (_a) {
    var account = _a.account, logout = _a.logout, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement("div", { className: "ctm-modal modal fade show", id: "myNft", style: { display: 'block' }, tabIndex: -1, "aria-labelledby": "exampleModalLabel", "aria-hidden": "true" },
        React.createElement("div", { className: "modal-dialog ctmmodal-dialog" },
            React.createElement("div", { className: "modal-content" },
                React.createElement("div", { className: "modal-header" },
                ...
                React.createElement("div", { className: "modal-body" },
                    ...
                    React.createElement("ul", { className: "mynft-body" },
                        React.createElement("li", null,
                            React.createElement("a", { href: "https://bscscan.com/address/" + account, target: "_blank", rel: "noreferrer" },
                                account,
                                " ",
                                React.createElement("span", null,
                ...
                React.createElement("div", { className: "col-sm-12 col-md-12 specialcard-wrap" },
                    React.createElement("div", { className: "specialcard" },
                        ...
                        React.createElement("ul", null,
                            React.createElement("li", null,
                                React.createElement(Link$1, { to: "/genesis-collection" }, "Explore Collection")))))))));
};
...
var StyledAvatar = styled.div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
var Pip = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
                        ...
                        React.createElement("div", { className: "collapse navbar-collapse", id: "navbarSupportedContent" },
                            React.createElement("ul", { className: "navbar-nav ms-auto mb-2 mb-lg-0 tp-nav" },
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(Link$1, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.SITE_BASE_URL + "/" + VLADLink.TOKEN_FACTS }, rel: "noopener noreferrer" }, "Token Facts")),
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(Link$1, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.APP_BASE_URL + "/" + VLADLink.FARMS }, rel: "noopener noreferrer" }, "Farms")),
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(Link$1, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.APP_BASE_URL + "/" + VLADLink.NFT }, rel: "noopener noreferrer" }, "NFTs")),
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(Link$1, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.SITE_BASE_URL + "/" + VLADLink.TEAM }, rel: "noopener noreferrer" }, "Team")),
                                React.createElement("li", { className: "nav-item" },
                                    React.createElement(Link$1, { className: "nav-link pactive", to: "/" }, "Marketplace"))),
                            React.createElement("ul", { className: "top-sm-nav ms-3" },
                                React.createElement("li", null,
                                    React.createElement(Link$1, { target: "_blank", to: { pathname: "https://t.me/VladFinanceOfficial" }, rel: "noopener noreferrer" },
                                        React.createElement("div", null,
                                            React.createElement("img", { src: "/assets/images/telegramicon.svg", className: "img-fluid", alt: "" })))),
                                React.createElement("li", null,
                                    React.createElement(Link$1, { target: "_blank", to: { pathname: "https://vlad-finance.medium.com/" }, rel: "noopener noreferrer" },
                                        React.createElement("div", null,
                                            React.createElement("img", { src: "/assets/images/mediumicon.svg", className: "img-fluid", alt: "" })))),
                                React.createElement("li", null,
                                    React.createElement(Link$1, { target: "_blank", to: { pathname: "https://twitter.com/VladFinance" }, rel: "noopener noreferrer" },
                                        React.createElement("div", null,
...
var BodyWrapper = styled.div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"])), function (_a) {
...
var MobileOnlyOverlay = styled(Overlay)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var alertTypeMap = (_a$1 = {},
    ...
    _a$1);
var StyledToast = styled.div(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
