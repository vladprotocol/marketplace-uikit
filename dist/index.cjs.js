...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: "ctm-modal modal fade show", id: "myNft", style: { display: 'block' }, tabIndex: -1, "aria-labelledby": "exampleModalLabel", "aria-hidden": "true" },
        React__default['default'].createElement("div", { className: "modal-dialog ctmmodal-dialog" },
            React__default['default'].createElement("div", { className: "modal-content" },
                React__default['default'].createElement("div", { className: "modal-header" },
                ...
                React__default['default'].createElement("div", { className: "col-sm-12 col-md-12 specialcard-wrap" },
                    React__default['default'].createElement("div", { className: "specialcard" },
                        ...
                        React__default['default'].createElement("ul", null,
                            React__default['default'].createElement("li", null,
                                React__default['default'].createElement(reactRouterDom.Link, { to: "/genesis-collection" }, "Explore Collection")))))))));
};
...
var StyledAvatar = styled__default['default'].div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"], ["\n  margin-left: 8px;\n  position: relative;\n\n  img {\n    border-radius: 50%;\n  }\n"])));
var Pip = styled__default['default'].div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
                        ...
                        React__default['default'].createElement("div", { className: "collapse navbar-collapse", id: "navbarSupportedContent" },
                            React__default['default'].createElement("ul", { className: "navbar-nav ms-auto mb-2 mb-lg-0 tp-nav" },
                                React__default['default'].createElement("li", { className: "nav-item" },
                                    React__default['default'].createElement(reactRouterDom.Link, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.SITE_BASE_URL + "/" + VLADLink.TOKEN_FACTS }, rel: "noopener noreferrer" }, "Token Facts")),
                                React__default['default'].createElement("li", { className: "nav-item" },
                                    React__default['default'].createElement(reactRouterDom.Link, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.APP_BASE_URL + "/" + VLADLink.FARMS }, rel: "noopener noreferrer" }, "Farms")),
                                React__default['default'].createElement("li", { className: "nav-item" },
                                    React__default['default'].createElement(reactRouterDom.Link, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.APP_BASE_URL + "/" + VLADLink.NFT }, rel: "noopener noreferrer" }, "NFTs")),
                                React__default['default'].createElement("li", { className: "nav-item" },
                                    React__default['default'].createElement(reactRouterDom.Link, { className: "nav-link", target: "_blank", to: { pathname: VLADLink.SITE_BASE_URL + "/" + VLADLink.TEAM }, rel: "noopener noreferrer" }, "Team")),
                                React__default['default'].createElement("li", { className: "nav-item" },
                            ...
                            React__default['default'].createElement("ul", { className: "top-sm-nav ms-3" },
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement(reactRouterDom.Link, { target: "_blank", to: { pathname: "https://t.me/VladFinanceOfficial" }, rel: "noopener noreferrer" },
                                        React__default['default'].createElement("div", null,
                                            React__default['default'].createElement("img", { src: "/assets/images/telegramicon.svg", className: "img-fluid", alt: "" })))),
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement(reactRouterDom.Link, { target: "_blank", to: { pathname: "https://vlad-finance.medium.com/" }, rel: "noopener noreferrer" },
                                        React__default['default'].createElement("div", null,
                                            React__default['default'].createElement("img", { src: "/assets/images/mediumicon.svg", className: "img-fluid", alt: "" })))),
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement(reactRouterDom.Link, { target: "_blank", to: { pathname: "https://twitter.com/VladFinance" }, rel: "noopener noreferrer" },
                                        React__default['default'].createElement("div", null,
...
var BodyWrapper = styled__default['default'].div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"])), function (_a) {
...
var MobileOnlyOverlay = styled__default['default'](Overlay)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var alertTypeMap = (_a$1 = {},
    ...
    _a$1);
var StyledToast = styled__default['default'].div(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
