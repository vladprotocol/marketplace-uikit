...
var IconButton = styled__default['default'](Button)(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  padding: 0;\n  width: ", ";\n"], ["\n  padding: 0;\n  width: ", ";\n"])), function (_a) {
    var size = _a.size;
    return (size === "sm" ? "32px" : "48px");
});
...
var Input$1 = styled__default['default'].input(templateObject_1$k || (templateObject_1$k = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
...
var GridLayout$1 = styled__default['default'].div(templateObject_1$j || (templateObject_1$j = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"], ["\n  display: grid;\n  grid-template-columns: repeat(6, 1fr);\n  grid-gap: 16px;\n  ", " {\n    grid-template-columns: repeat(8, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 24px;\n  }\n  ", " {\n    grid-template-columns: repeat(12, 1fr);\n    grid-gap: 32px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
}, function (_a) {
    var theme = _a.theme;
...
var StyledLink = styled__default['default'](Text)(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var Pulse = styled__default['default'](Root)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  animation: ", " 2s infinite ease-out;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 2s infinite ease-out;\n  transform: translate3d(0, 0, 0);\n"])), pulse);
...
var StyledModal = styled__default['default'].div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"], ["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$D, { color: "primary" }))),
...
var ModalWrapper$1 = styled__default['default'].div(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: ", ";\n"])), function (_a) {
    var theme = _a.theme;
...
var ModalProvider = function (_a) {
    ...
    return (React__default['default'].createElement(Context.Provider, { value: {
        ...
        isOpen && (React__default['default'].createElement(ModalWrapper$1, null,
...
var ConnectModal = function (_a) {
    ...
    //   {/* </HelpLink> */}
    // </Modal>
    React__default['default'].createElement("div", { className: "ctm-modal modal fade", id: "connectNft", tabIndex: -1, "aria-labelledby": "exampleModalLabel", "aria-hidden": "true" },
        React__default['default'].createElement("div", { className: "modal-dialog ctmmodal-dialog" },
            React__default['default'].createElement("div", { className: "modal-content" },
                ...
                React__default['default'].createElement("div", { className: "modal-body" },
                    React__default['default'].createElement("ul", { className: "wallet-body" },
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/metamask.svg" })))),
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/trustwallet.svg", alt: "trust wallet icon" })))),
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/mathwallet.svg", alt: "mathwallet" })))),
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/tokenpocket.svg", alt: "token pocket" })))),
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/walletconnect.svg", alt: "walletconnect" })))),
                        React__default['default'].createElement("li", null,
                            React__default['default'].createElement("a", { href: "#" },
                                "Metamask ",
                                React__default['default'].createElement("span", null,
                                    React__default['default'].createElement("img", { src: "assets/images/binancechain.svg", alt: "binancechain" }))))),
                ...
                React__default['default'].createElement("div", { className: "col-sm-12 col-md-12 specialcard-wrap" },
                    React__default['default'].createElement("div", { className: "specialcard" },
                        ...
                        React__default['default'].createElement("ul", null,
                            React__default['default'].createElement("li", null,
                                React__default['default'].createElement(reactRouterDom.Link, { to: "/vlad-collection" }, "Explore Collection")))))))));
};
...
var BodyWrapper = styled__default['default'].div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner = styled__default['default'].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  ", " {\n    margin-left: ", ";\n  }\n"])), function (_a) {
...
var MobileOnlyOverlay = styled__default['default'](Overlay)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var Menu = function (_a) {
    ...
    var _b = React.useState(false), isPushed = _b[0], setIsPushed = _b[1];
...
exports.AddIcon = Icon$E;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$D;
exports.ArrowDownIcon = Icon$C;
exports.ArrowDropDownIcon = Icon$B;
...
exports.CheckmarkCircleIcon = Icon$I;
...
exports.ErrorIcon = Icon$H;
exports.Flex = Flex;
exports.GooseRoundIcon = Icon$c;
exports.Heading = Heading;
exports.HelpIcon = Icon$k;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$F;
...
exports.ProgressBunny = Icon$8;
exports.Radio = Radio;
exports.RemoveIcon = Icon$a;
exports.ResetCSS = ResetCSS;
exports.SearchIcon = Icon$4;
exports.Skeleton = Skeleton;
exports.Spinner = Spinner;
exports.Svg = Svg;
exports.SwapVertIcon = Icon$3;
exports.SyncAltIcon = Icon$2;
exports.Tag = Tag;
exports.Text = Text;
exports.Ticket = Icon$6;
exports.TicketRound = Icon$5;
exports.ToastContainer = ToastContainer;
exports.Toggle = Toggle;
exports.VerifiedIcon = Icon$9;
